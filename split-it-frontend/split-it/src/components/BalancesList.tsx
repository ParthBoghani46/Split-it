              ...
              {balance !== 0 && (
                <div
                  className={cn(
                    ...
                    isLeft
                      ? "bg-green-300 dark:bg-green-800 left-0 rounded-r-lg border border-green-300 dark:border-green-700"
                      : "bg-red-300 dark:bg-red-800 right-0 rounded-l-lg border  border-red-300 dark:border-red-700"
                  )}
                  style={{
